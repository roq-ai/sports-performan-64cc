            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('athlete', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>athlete</Th>}
                  <Th>Actions</Th>
                </Tr>
              </Thead>
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('athlete', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>{record?._count?.athlete}</Td>
                    )}
                    <Td>
